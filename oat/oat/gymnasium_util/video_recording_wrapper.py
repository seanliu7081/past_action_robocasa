import gymnasium
import numpy as np
from oat.common.video_recorder import VideoRecorder



class AsyncVecRlbenchVideoRecordingWrapper(gymnasium.Wrapper):
    def __init__(self, 
            env, 
    ...
    def reset(self, **kwargs):
        ...
        self.frames = list()
        self.step_count = 1
        # self.video_recoder.stop()     # NOTE: a hack for async rlbench env
        return obs, info
