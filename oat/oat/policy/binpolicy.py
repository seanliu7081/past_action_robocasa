...
class BinPolicy(BasePolicy):
    def __init__(
        ...
        # create AR model
        codebook_size = action_tokenizer.num_bins
        max_seq_len = horizon * action_dim
    ...
    def predict_action(self, 
        ...
        with torch.inference_mode():
            action_pred = self.action_tokenizer.detokenize(
                token_ids=action_tokens.view(B, self.horizon, self.action_dim)
            )   # [B, horizon, Da]
    ...
    def forward(self, batch) -> torch.Tensor:
        ...
        with torch.inference_mode():
            ...
            action_tokens = action_tokens.view(B, -1)  # [B, T*Da]
